...
. Add the new word on a new line. You do not need to sort entries or maintain a word count.
+
--
...
Lowercase words automatically get a title case counterpart in the dictionary.
For example, adding `spyre` also generates `Spyre`.
